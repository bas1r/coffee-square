...
const Nav = () => {
    ...
    <Link href="/" className="d-flex align-items-center text-dark text-decoration-none">
      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-chat-square-quote-fill me-2" viewBox="0 0 16 16">
      ...
      <span className="fs-4">CoffeeSquare</span>
    </Link>
  </header>;
}
